    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int position) {
                ...
                RemoteViews views = new RemoteViews(getPackageName(), R.layout.collection_item);
                ...
                if (data.getInt(data.getColumnIndex(QuoteColumns.ISUP)) == 1) {
                    views.setInt(R.id.change, getString(R.string.widget_background), R.drawable.percent_change_pill_green);
                } else {
                    views.setInt(R.id.change, getString(R.string.widget_background), R.drawable.percent_change_pill_red);
                }
                return views;
            }
